...
addMissionEventHandler ["Draw3D", {
    
    {
        ...
        private _offset = _position select 2 + 2;
        _position set [2, _offset];
        private _string = _x getVariable ["currentlyThinking", "nothing"];
      drawIcon3D ["", [1,0,0,1], _position, 0, 0, 0, _string, 1, 0.05, "PuristaMedium"];
    } forEach vehicles;
}];
